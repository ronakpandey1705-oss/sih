...
class Product(Base):
    ...
    expected_net_quantity = Column(String(512), nullable=False)
    expected_mrp = Column(String(128), nullable=False)
    manufacturer = Column(String(255), nullable=False)
    manufacturer_address = Column(String(1024), nullable=False)
    packer = Column(String(255), nullable=True)
    importer = Column(String(255), nullable=True)
    consumer_care_details = Column(String(1024), nullable=True)
